...
class RoomMembersConsumer(AsyncWebsocketConsumer):
	...
	async def start_game(self, event):
		...
		"""
		msg = {'type': 'start_game', 'data': event['data']}
		await self.send(text_data=json.dumps(msg))
	...
	async def countdown_start(self, event):
		...
		"""
		msg = {'type': 'countdown_start', 'data': event['data']}
		await self.send(text_data=json.dumps(msg))
	...
	async def countdown_update(self, event):
		...
		"""
		msg = {'type': 'countdown_update', 'data': event['data']}
		await self.send(text_data=json.dumps(msg))
	...
	async def countdown_end(self, event):
		...
		"""
		msg = {'type': 'countdown_end', 'data': event['data']}
		await self.send(text_data=json.dumps(msg))
	...
	async def new_question(self, event):
		...
		"""
		msg = {'type': 'new_question', 'data': event['data']}
		await self.send(text_data=json.dumps(msg))
	...
	async def solve_question(self, event):
		...
		"""
		msg = {'type': 'solve_question', 'data': event['data']}
		await self.send(text_data=json.dumps(msg))
	...
	async def clear_question(self, event):
		...
		"""
		msg = {'type': 'clear_question', 'data': event['data']}
		await self.send(text_data=json.dumps(msg))
	...
	async def end_game(self, event):
		...
		"""
		msg = {'type': 'end_game', 'data': event['data']}
		await self.send(text_data=json.dumps(msg))
	...
	async def user_answers(self, event):
		...
		"""
		msg = {'type': 'user_answers', 'data': event['data']}
		await self.send(text_data=json.dumps(msg))
